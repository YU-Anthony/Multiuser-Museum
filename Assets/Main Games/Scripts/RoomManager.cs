...
{
    [SerializeField]
    TextMeshProUGUI OccupancyRateText_ForGallery;
    ...
    public void OnEnterRoomButtonClicked_Gallery()
    {
        mapType = MultiplayerVRConstants.MAP_TYPE_VALUE_GALLERY;
        ExitGames.Client.Photon.Hashtable expectedCustomRoomProperties = new ExitGames.Client.Photon.Hashtable() { { MultiplayerVRConstants.MAP_TYPE_KEY, mapType } };
        PhotonNetwork.JoinRandomRoom(expectedCustomRoomProperties, 0);
    }
    #endregion
    ...
    public override void OnJoinedRoom()
    {
        ...
        if (PhotonNetwork.CurrentRoom.CustomProperties.ContainsKey(MultiplayerVRConstants.MAP_TYPE_KEY))
        {
            ...
            if (PhotonNetwork.CurrentRoom.CustomProperties.TryGetValue(MultiplayerVRConstants.MAP_TYPE_KEY, out mapType))
            {
                ...
                if ((string)mapType == MultiplayerVRConstants.MAP_TYPE_VALUE_GALLERY)
                {
                    //Load the Gallery scene
                    PhotonNetwork.LoadLevel("World_Gallery");
    ...
    public override void OnRoomListUpdate(List<RoomInfo> roomList)
    {
        if (roomList.Count == 0)
        {
            ...
            OccupancyRateText_ForGallery.text = 0 + " / " + 20;
        ...
        foreach (RoomInfo room in roomList)
        {
            ...
            else if (room.Name.Contains(MultiplayerVRConstants.MAP_TYPE_VALUE_GALLERY))
            {
                //Update the Gallery room map
                Debug.Log("Room is a GALLERY map. Player count is: " + room.PlayerCount);

                OccupancyRateText_ForGallery.text = room.PlayerCount + " / " + 20;
            }
    ...
    void CreateAndJoinRoom()
    {
        ...
        //There are 2 different maps: Outdoor and Gallery
        //1.Outdoor = "outdoor"
        //2.Gallery = "gallery"
